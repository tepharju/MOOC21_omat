...
def genren_kirjat(kirjat:list, genre:str):
    lista = []
    for alkio in kirjat:   #Käydään kirjat-lista yksitellen läpi. 
        if alkio.genre == genre:  #Katsotaan jokaisen Kirja-olion muuttujaa genre ja verrataan vastaako se haluttua genreä
            lista.append(alkio)
